...
namespace DHGSystems.FileSortingWithLimitedMemory
{
    ...
    public class FileMergerWithSortingWithAsyncWriteTest
    {
        ...
        public void ProcessOneFile_Should_BePositive()
        {
            ...
            sorter.MergeFilesWithSort(new string[] { oneRowTestFile }, outputFilePath);
        ...
        public void ProcessMultiLineRowFile_Should_BePositive()
        {
            ...
            FileMergerWithSortingWithAsyncWrite sorter = new FileMergerWithSortingWithAsyncWrite();
            sorter.MergeFilesWithSort(new string[] { emailTestResultFile }, outputFilePath);
            var fileContent = File.ReadAllText(outputFilePath);
        ...
        public void Process_Multiple_Files_With_The_Same_Values_Should_Be_Positive()
        {
            ...
            FileMergerWithSortingWithAsyncWrite sorter = new FileMergerWithSortingWithAsyncWrite();
            sorter.MergeFilesWithSort(new string[] { emailTestResultFile, emailTestResultFile, emailTestResultFile, emailTestResultFile, emailTestResultFile, emailTestResultFile }, outputFilePath);
